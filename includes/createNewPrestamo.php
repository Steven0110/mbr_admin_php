...
foreach ($_POST['prodCode'] as $key => $value) {
	...
	$sql = "INSERT INTO prestamos (ID_PRESTAMO,ID_PROYECTO, ID_EMPLEADO, ID_STORE, ID_HERRAMIENTA,CREATED_AT,END_DATE,REMARKS,STATUS,qty) VALUES ('$nuevoID','$proyect', '$empEnc','$store', '$value', CURRENT_TIMESTAMP,'$fchterm','$remarks','A','$quant')";
	$retval = $db->query($sql);
	if(! $retval )
	{
