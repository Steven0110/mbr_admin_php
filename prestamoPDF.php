...
// Lineas
$queryTran = "SELECT t1.qty qty,t2.code prodCode, t2.name name FROM prestamos t1 INNER JOIN product t2 on t1.ID_HERRAMIENTA = t2.code WHERE t1.ID_PRESTAMO = '$infID'";
