...
if ($registros > 0) {
  ...
  while($row = mysql_fetch_object($result)){
	...
	$res100 = $db->query($byStqry);
	
	$i = 2;   
  while($suc100 = $res100->fetch()){
...
/* inventario sucursal 101 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res101 = $db->query($byStqry);
	
	$i = 2;   
  while($suc101 = $res101->fetch()){
...
/* inventario sucursal 102 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res102 = $db->query($byStqry);
	
	$i = 2;   
  while($suc102 = $res102->fetch()){
...
/* inventario sucursal 103 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res103 = $db->query($byStqry);
	
	$i = 2;   
  while($suc103 = $res103->fetch()){
...
/* inventario sucursal 104 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res104 = $db->query($byStqry);
	
	$i = 2;   
  while($suc104 = $res104->fetch()){
...
/* inventario sucursal 105 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res105 = $db->query($byStqry);
	
	$i = 2;   
  while($suc105 = $res105->fetch()){
...
/* inventario sucursal 106 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res106 = $db->query($byStqry);
	
	$i = 2;   
  while($suc106 = $res106->fetch()){
...
/* inventario sucursal 107 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res107 = $db->query($byStqry);
	
	$i = 2;   
  while($suc107 = $res107->fetch()){
...
/* inventario sucursal 108 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res108 = $db->query($byStqry);
	
	$i = 2;   
  while($suc108 = $res108->fetch()){
...
/* inventario sucursal 109 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res109 = $db->query($byStqry);
	
	$i = 2;   
  while($suc109 = $res109->fetch()){
...
/* inventario sucursal 110 */
	...
	$byStqry.= " FROM product T1 ORDER BY T1.name ASC";
	$res110 = $db->query($byStqry);
	
	$i = 2;   
  while($suc110 = $res110->fetch()){
